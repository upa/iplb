...
class Topology () :
    ...
    def bench_switch_one_to_all (self, switches) :
        sws = copy.deepcopy (switches)
        src = sws.pop (0)
...
def main (links, clients, switches, options) :
    ...
    combination = topo.bench_switch_one_to_all (switches)
    ...
    print "comment: calculated dstination count %d" % (len (combination))
